...
namespace Drupal\acquia_cms_headless\Form;
...
class InstallationWizardForm extends FormBase {
  ...
  public function getFormId() {
    return 'acquia_cms_headless_installation_wizard';
  }
   ...
   */
  public function __construct(ClassResolverInterface $class_resolver, Renderer $renderer, StateInterface $state, AcquiaCmsHeadlessManager $acquia_cms_headless_manager) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('acquia_cms_headless.enabled_modules');
  }
  ...
  public function getTitleMarkup(string $module_title, int $current_step): string {
    $title_markup = [
      '#theme' => 'acquia_cms_headless_title_markup',
