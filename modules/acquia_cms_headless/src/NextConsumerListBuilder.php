 ...
 */
class NextConsumerListBuilder extends EntityListBuilder {
  ...
  public function buildHeader() {
    ...
    $context = ['type' => 'header'];
    $this->moduleHandler()->alter('nextconsumers_list', $header, $context);
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\acquia_cms_headless\Entity\NextConsumer */
    ...
    $this->moduleHandler()->alter('nextconsumers_list', $row, $context);
