...
namespace Drupal\acquia_cms_headless\Entity;
...
/**
 * Defines the NextConsumer entity.
 *
 * @ContentEntityType(
 *   id = "nextconsumer",
 *   label = @Translation("NextConsumer"),
 *   handlers = {
 *     "list_builder" = "Drupal\acquia_cms_headless\NextConsumerListBuilder",
 *     "form" = {
 *       "default" = "Drupal\acquia_cms_headless\Entity\Form\NextConsumerForm",
 *       "add" = "Drupal\acquia_cms_headless\Entity\Form\NextConsumerForm",
 *       "edit" = "Drupal\acquia_cms_headless\Entity\Form\NextConsumerForm",
 *       "delete" = "Drupal\Core\Entity\ContentEntityDeleteForm",
 *       "make-default" = "Drupal\cacquia_cms_headless\Entity\Form\MakeDefaultForm",
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\acquia_cms_headless\Entity\Routing\HtmlRouteProvider",
 *     },
 *     "views_data" = "\Drupal\views\EntityViewsData",
 *     "access" = "Drupal\acquia_cms_headless\AccessControlHandler",
 *     "storage" = "Drupal\acquia_cms_headless\NextConsumerStorage",
 *   },
 *   base_table = "nextconsumer",
 *   data_table = "nextconsumer_field_data",
 *   translatable = TRUE,
 *   admin_permission = "administer nextconsumer entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "label",
 *     "uuid" = "uuid",
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/config/services/next/consumer/{nextconsumer}",
 *     "collection" = "/admin/config/services/next/consumer",
 *     "add-form" = "/admin/config/services/next/consumer/add",
 *     "edit-form" = "/admin/config/services/next/consumer/{nextconsumer}/edit",
 *     "delete-form" = "/admin/config/services/next/consumer/{nextconsumer}/delete",
 *     "make-default-form" = "/admin/config/services/next/consumer/{nextconsumer}/make-default",
 *   }
 * )
 */
class NextConsumer extends ContentEntityBase implements EntityOwnerInterface {
  ...
  protected function removeDefaultConsumerFlags() {
    ...
    if (empty($entity_ids)) {
      ...
      $invalid_entities = array_filter($default_entities, function (NextConsumer $consumer) {
  ...
  protected static function setDefaultTo($value) {
    return function (NextConsumer $consumer) use ($value) {
