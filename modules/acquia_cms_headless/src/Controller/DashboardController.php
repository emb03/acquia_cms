...
final class DashboardController extends ControllerBase {
  ...
  public function content() {
    ...
    $link_url = Url::fromRoute('acquia_cms_headless.welcome_modal_form');
    if (!$show_welcome_dialog) {
      $link_url = Url::fromRoute('acquia_cms_headless.installation_wizard');
    }
    $link_url->setOptions([
      'attributes' => [
        'class' => [
    ...
    // Attach acquia_cms_headless_dashboard library.
    $build['#attached'] = [
      'library' => [
