...
use Drupal\acquia_cms_headless\Form\AcquiaCMSDashboardBase;
 ...
 * )
 */
class NextConsumerForm extends AcquiaCMSDashboardBase {
  ...
  public function getFormId() {
    return 'acquia_cms_next_consumer_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($this->isModuleEnabled()) {
      ...
      $form[$module]['web_property_id'] = [
        ...
        '#placeholder' => 'Next.js consumer',
        '#default_value' => $this->config('nextconsumer.settings')->get('label'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('nextconsumer.settings')->set('label', $property_id)->save();
    $this->state->set('nextconsumer_progress', TRUE);
  ...
  public function checkMinConfiguration() {
    $label = $this->config('nextconsumer.settings')->get('label');
